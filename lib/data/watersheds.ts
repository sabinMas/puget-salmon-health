...
const mockWatersheds: Watershed[] = [
  ...
  { id: '3', name: 'Lake Washington/Cedar/Sammamish',  slug: 'lake-washington', region: 'Central Sound', areaSqKm: 1265, status: 'concern',  geoJsonName: 'Cedar-Sammamish River' },
  { id: '4', name: 'Green/Duwamish River',             slug: 'green-duwamish', region: 'Central Sound', areaSqKm: 1945, status: 'concern',  geoJsonName: 'Duwamish River'         },
  { id: '5', name: 'Puyallup/White River',             slug: 'puyallup-white', region: 'South Sound',   areaSqKm: 2406, status: 'caution',  geoJsonName: 'Puyallup-White River'   },
